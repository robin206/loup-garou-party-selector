...
const Index = () => {
  return <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-gray-900 to-black text-white">
      <Header />
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto pt-24 pb-12 px-4">
        <section className="text-center mb-10 space-y-4">
          ...
          <h1 className="text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl animate-fade-up">Loup Garou de Thiercelieux - Maitre du jeu</h1>
          
          <p className="mx-auto max-w-2xl text-gray-400 text-lg animate-fade-up" style={{
          animationDelay: '0.1s'
        }}>
